...
class StackedAutoEncoders:
    def __init__(self, params = None save_path='', CVO=None, inovelty = 0):
    ...
    def get_neurons_str(self, data, hidden_neurons=[]):
    ...
    def get_model(self, data, trgt, hidden_neurons=[1], layer=1, ifold=0):
    ...
    def get_encoder(self, data, trgt, hidden_neurons=[1], layer=1, ifold=0):
    ...
    def trainLayer(self, data=None, trgt=None, ifold=0, hidden_neurons=[400], layer=1):
        ...
        for i_init in range(self.n_inits):
            ...
            if layer == 1:
                ...
                model.add(Dense(units=hidden_neurons[layer - 1], input_dim=data.shape[1], kernel_initializer=self.parameters["HyperParameters"]["kernel_initializer"]))
                model.add(Activation(self.parameters["HyperParameters"]["hidden_activation"]))
                model.add(Dense(units=data.shape[1], input_dim=hidden_neurons[layer - 1], kernel_initializer=self.parameters["HyperParameters"]["kernel_initializer"]))
                model.add(Activation(self.parameters["HyperParameters"]["output_activation"]))
            elif layer > 1:
    ...
    def loadClassifier(self, data=None, trgt=None, hidden_neurons=[1], layer=1, ifold=0, regularizer=None,
    ...
    def trainClassifier(self, data=None, trgt=None, ifold=0, hidden_neurons=[1], layer=1, regularizer=None,
                        regularizer_param=None):
        for i in range(len(hidden_neurons)):
            if hidden_neurons[i] == 0:
                hidden_neurons[i] = 1
        ...
        model_str = os.path.join(self.save_path,
                                      self.classifier_prefix_str + "_%s_neurons" % (self.inovelty, neurons_str))
        ...
        for i_init in range(self.n_inits):
            ...
            # Add Output Layer
            model.add(Dense(units=trgt_sparse.shape[1], kernel_initializer=self.parameters["HyperParameters"]["kernel_initializer"]))
