...
Class created to implement a Stacked Auto Encoder for Project of Novelty Detection.
...
class StackedAutoEncoder:
    def __init__(self, trn_params = None, development_flag = False, n_folds = 2):
    ...
    '''
    def StackedAutoEncoderTrainFunction(self, data=None, trgt=None, ifold=0, n_neurons=10, save_path='', hidden_neurons = [400]):

        layer = len(hidden_neurons)
